                                                ...
                                                <tr key={key}>
                                                    ...
                                                    {records.map((r, i) => (
                                                        <td key={i} className="p-3 text-center align-top">
                                                            {r === 1 && <div className="w-3 h-3 rounded-full bg-green-500 mx-auto" title="Present"></div>}
                                                            {r === 2 && <div className="w-3 h-3 rounded-full bg-red-500 mx-auto" title="Absent"></div>}
